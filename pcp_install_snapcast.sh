...
# An attempt to debug install on Raspi Zero2W
# ==============================================================================
...
if [ "$ARCH" = "aarch64" ]; then
    ...
    SNAP_DEB_ARCH="armhf"
    TC_REPO_URL="https://repo.picoreplayer.org/repo/16.x/armhf/tcz/"
else
...
DEPENDENCIES="avahi.tcz flac.tcz libvorbis.tcz dbus.tcz libavahi.tcz opusfile.tcz expat2.tcz pcp-libsoxr.tcz gcc_libs.tcz"
